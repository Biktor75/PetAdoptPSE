...
public class RefugiosFacadeREST extends AbstractFacade<Refugios> {
    ...
    public RefugiosFacadeREST() {
        super(Refugios.class);
    }

    @POST
    @Override
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void create(Refugios entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") String id, Refugios entity) {
        super.edit(entity);
    }
    ...
    public Refugios find(@PathParam("id") String id) {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<Refugios> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
